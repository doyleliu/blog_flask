...
from flask import Flask, Markup, render_template, abort ,request, jsonify
...
def add():
    ...
    processor = "./static/seek.py"
    pargs = [INTERPRETER, processor,"-query","thumbnails/"+ str(a),"-index", "features_final.h5","-result","thumbnails"] 
